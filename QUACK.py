...
###Adding information about % of total contamination and spikeins in the library:
G = ["", "", "", "",] + Statistics[-2] + [""] ### Filling first 4 cells and last one in the last row
TABLE.append(G)
